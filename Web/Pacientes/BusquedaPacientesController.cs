...
{
	public class BusquedaPacientesController
	{
		...
		public static List<Paciente> PacientesItems { get; set; }
//        {
//            get
//            {
...
//        }
		...
		//Constructor
		public BusquedaPacientesController ()
		{
...
//salasRecuperadas.Cast[T]().ToList();
		...
		public static void UpdateData(IList<Paciente> pacientes){
			PacientesItems=pacientes.Cast<Paciente>().ToList();
			log.Debug("Actualizando "+PacientesItems.Count+" pacientes encontrados");
			ListAsDataTable();
		}
...
//        {
//			if(PacientesItems==null){
//				PacientesItems=new List<Paciente>(); 
//			}
//            return Utilidad.ToDataTable<Paciente>(PacientesItems);
//        }
		
		public static List<Paciente> ListAsDataTable()
        {
			if(PacientesItems==null){
				PacientesItems=new List<Paciente>(); 
			}
            return PacientesItems;
        }
...
//        }
		        ...
		        public void Update(int id,string nombre, string apellido1)
        {
